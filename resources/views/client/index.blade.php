        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header" id="success-color">
                    <h5 id="title">
                        <button type="button" data-bs-toggle="modal" data-bs-target="#client_insert_modal" data-whatever="@mdo"
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label" for="AltnativeContact">Altnative Contact:</label>
                                    <input class="form-control" type="text" id="EditAltnativeContact"
                                        name="AltnativeContact">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label" for="Country">Country:</label>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="col-form-label" for="OthersInf">OthersInf:</label>
                                    <input type="text" name="OthersInf" class="form-control" id="EditOthersInf"
                                        placeholder="type others information">
                                    {{-- <textarea name="OthersInf" class="form-control" id="" cols="30" rows="10" placeholder="type others information"></textarea> --}}
