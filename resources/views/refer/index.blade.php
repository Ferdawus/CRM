                ...
                @foreach ($Referes as $Refer)
                  <tr>
                    ...
                    <td class="d-flex">
                      ...
                      <button type="button" data-bs-toggle="modal" data-bs-target="#edit_modal" data-whatever="@mdo" class="btn btn-primary-light EditBtn"  data-bs-original-title="" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-id="{{$Refer->id}}">
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel2">Update Refer</h5>
                  <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  {{ Form::open(['url' => '/refer','method'=>'POST','id'=>'ReferEditForm','class'=>'theme-form','files'=> true]) }}
                ...
                <div class="modal-footer">
                    ...
                    <button class="btn btn-primary" type="submit">Update Refered By</button>
                </div>
